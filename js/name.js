...
var btn7=my$("btn7");
var btn8=my$("btn8");
var btnArrone=[btn1,btn3,btn5,btn7];
var btnArrtwo=[btn2,btn4,btn6,btn8];
var lis=document.getElementsByTagName("li");
var clss= document.getElementsByClassName("cls");
var arrContent=[];
var content=my$("thenames");
var setId1=null;
var setId2=null;
var setId3=null;
var setId4=null;
...
btn1.onclick=function(){
    ...
    setId1=setInterval(function(){
        ...
        if(txtValue1==""){
            ...
            arr.push(num);
        }else if(txtValue1-parseInt(txtValue1)>0||txtValue1-parseInt(txtValue1)<0||txtValue1>85||txtValue1<=0){
            self.value="点我"
            alert("请填入一个1-85的正整数");
            clearAllInt(setId1,setId2,setId3,setId4);
        }else if(txtValue1-txtValue1==0){
            while(arr.length<txtValue1) {
                var num = Math.floor((Math.random() * (lis.length)));
    ...
    if(this.value=="暂停"){
        ...
        for(var i=0;i<clss.length;i++){
            arrContent.push(getInnerTxt(clss[i]));
        }
        content.innerHTML="总："+"<br />"+arrContent;
        return;
    }
    this.value="暂停";
};
